...
<body>
<div class="konten">
	<h2><div align="center">LEMBAR HASIL DIAGNOSA PASIEN</h2><hr>
	<?php
include "koneksi.php";
...
<table width="100%" border="0" bgcolor="#0099FF" cellspacing="1" cellpadding="4" bordercolor="#0099FF">
  <tr bgcolor="#ffffff">
	...
	echo "<label>Gejala yang dirasakan : </label><br>";
...
while($row_sumtmp=mysql_fetch_array($query_sum_tmp)){
	...
	while ($row_penyasol=mysql_fetch_array($query_penyasol)){
		...
		if($persen==100||$persen>=70){
			echo "<strong>Nama Penyakit ". $row_penyasol['nama_penyakit'] ."</strong><br>";
