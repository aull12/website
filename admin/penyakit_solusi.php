...
<table id="tabel" width="100%" cellpadding="3" cellspacing="0" border="1" align="center">
  <tr valign="top" bgcolor="#66CCCC">
  	<td width="108"><div align="center"><strong>No.</strong></td>
    <td width="108"><div align="center"><strong>Kode Penyakit </strong></td>
    <td width="200"><div align="center"><strong>Nama Penyakit</strong></td>
	<td width="200"><div align="center"><strong>Definisi</strong></td>
    <td width="256"><div align="center"><strong>Solusi</strong></td>
    <td width="48"><div align="center"><strong>Edit</strong></td>
    <td width="53"><div align="center"><strong>Hapus</strong></td>
  </tr>
  <?php
	include "../koneksi.php";
  ...
  <tr valign="baseline">
    ...
    <td><div align="center"><?php echo $data['kd_penyakit']; ?></td>
    <td><div align="center"><?php echo $data['nama_penyakit']; ?></td>
	<td><p class="text">
    <?php
	$str=$data['definisi'];
