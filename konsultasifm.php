  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bordercolor="#FFFFFF">
	...
	?>
	  ...
	  <?php
	   ...
	   if (isset($_POST['gejala22'])) echo $_POST['gejala22']."<br />";
	   if (isset($_POST['gejala23'])) echo $_POST['gejala23']."<br />";
	   if (isset($_POST['gejala24'])) echo $_POST['gejala24']."<br />";
	   if (isset($_POST['gejala25'])) echo $_POST['gejala25']."<br />";
	   ?>
